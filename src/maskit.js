...
export default class Maskit {
    ...
    setUniformLocations(gl, program) {
        this.uniLocations = [];
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.uv'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.k'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.symmetricalPoint'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.lineLeftNormal'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.lineLeftPoints'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.lineRightNormal'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.lineRightPoints'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.inversionCircle'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.ui'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.drawLines'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.drawCircle'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.drawInner'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.applyInversion'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.trackOrbit'));
        this.uniLocations.push(gl.getUniformLocation(program, 'u_maskit.orbitPoints'));
    }

    setUniformValues(gl) {
        let uniI = 0;
        gl.uniform2f(this.uniLocations[uniI++],
                     this.t.re, this.t.im);
        gl.uniform1f(this.uniLocations[uniI++], this.k);
        gl.uniform2f(this.uniLocations[uniI++],
                     this.symmetricalPoint.re, this.symmetricalPoint.im);
        // left line
        gl.uniform2f(this.uniLocations[uniI++],
                     this.lineLeftNormal.re, this.lineLeftNormal.im);
        gl.uniform4f(this.uniLocations[uniI++],
        ...
        // ui
        gl.uniform3f(this.uniLocations[uniI++],
                     this.pointRadius, this.lineWidth, this.circumferenceWidth);
        gl.uniform1i(this.uniLocations[uniI++],
                     this.drawLines);
        gl.uniform1i(this.uniLocations[uniI++],
                     this.drawCircle);
        gl.uniform1i(this.uniLocations[uniI++],
        ...
        gl.uniform1i(this.uniLocations[uniI++],
                     this.trackOrbit);
        // trackedOrbit
        gl.uniform2fv(this.uniLocations[uniI++],
                      this.orbitPoints);
    }
